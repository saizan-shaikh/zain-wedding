    ...
    >
      ...
      <div className="relative z-20 flex flex-col items-center justify-center gap-4 md:gap-[3vh] w-full max-w-[min(100vw,calc(100vh*0.45))] h-full px-6 py-12 mx-auto">
        ...
        <CinematicElement delayOffset={1} duration={3}>
          <h2 className="font-arabic text-xl md:text-2xl text-[#3B4232] drop-shadow-sm leading-relaxed mt-[5vh]">
        ...
        <CinematicText 
          ...
          delayOffset={3.5}
          wordDelay={0.3}
          className="font-sans text-[8px] md:text-[10px] tracking-[0.2em] text-[#5C6551] uppercase mt-2"
        />
        ...
        {/* 4. DATE */}
        <CinematicElement delayOffset={13} className="flex items-center space-x-4 text-[#5C6551] my-1">
          <span className="h-[1px] w-6 md:w-10 bg-[#A68F63]/40 block" />
          <p className="font-serif text-[10px] md:text-xs tracking-[0.2em] whitespace-nowrap text-[#454D3C]">
        ...
        <CinematicText 
          ...
          delayOffset={15}
          wordDelay={0.2}
          className="font-sans text-[8px] md:text-[9px] tracking-[0.1em] text-[#5C6551] max-w-[200px] md:max-w-xs leading-loose uppercase mb-[8vh]"
        />
      </div>
    </motion.div>
  );
